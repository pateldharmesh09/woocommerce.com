 ...
 * @since   1.0.0
 */
class ShopMagic_OrderCompleted_Event extends ShopMagic_OrderCommon_Event {


    static protected $name = "Order Completed";
    static protected $slug = "shopmagic_order_completed_event";
    static protected $description = 'Triggered when order status is set to completed';
