 ...
 * @since   1.0.0
 */
class ShopMagic_OrderPending_Event extends ShopMagic_OrderCommon_Event {


    static protected $name = "Order Pending";
    static protected $slug = "shopmagic_order_pending_event";
    static protected $description = 'Triggered when order is pending';
     ...
     */
     protected function setup_hook() {
         ...
         add_action('woocommerce_order_status_pending', array($this, 'process_event'));
     }
