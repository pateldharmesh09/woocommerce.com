 ...
 * @since   1.0.0
 */
class ShopMagic_OrderRefunded_Event extends ShopMagic_OrderCommon_Event {


    static protected $name = "Order Refunded";
    static protected $slug = "shopmagic_order_refunded_event";
    static protected $description = 'Triggered when the order has been refunded';
     ...
     */
     protected function setup_hook() {
         ...
         add_action('woocommerce_order_status_refunded', array($this, 'process_event'));
     }
