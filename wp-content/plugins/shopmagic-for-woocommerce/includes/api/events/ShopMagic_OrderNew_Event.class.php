 ...
 * @since   1.0.0
 */
class ShopMagic_OrderNew_Event extends ShopMagic_OrderCommon_Event {


    static protected $name = "New Order";
    static protected $slug = "shopmagic_order_new_event";
    static protected $description = 'Triggered when a new order is created';
     ...
     */
     protected function setup_hook() {
         ...
         add_action('woocommerce_new_order', array($this, 'process_event'));
     }
