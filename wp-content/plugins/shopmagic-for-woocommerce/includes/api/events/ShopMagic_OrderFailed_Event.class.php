 ...
 * @since   1.0.0
 */
class ShopMagic_OrderFailed_Event extends ShopMagic_OrderCommon_Event {


    static protected $name = "Order Failed";
    static protected $slug = "shopmagic_order_failed_event";
    static protected $description = 'Triggered when an order fails';
     ...
     */
     protected function setup_hook() {
         ...
         add_action('woocommerce_order_status_failed', array($this, 'process_event'));
     }
