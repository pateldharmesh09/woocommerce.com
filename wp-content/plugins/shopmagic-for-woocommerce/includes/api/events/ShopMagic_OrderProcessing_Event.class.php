 ...
 * @since   1.0.0
 */
class ShopMagic_OrderProcessing_Event extends ShopMagic_OrderCommon_Event {


    static protected $name = "Order Processing";
    static protected $slug = "shopmagic_order_processing_event";
    static protected $description = 'Triggered when order status is processing';
     ...
     */
     protected function setup_hook() {
         ...
         add_action('woocommerce_order_status_processing', array($this, 'process_event'));
     }
