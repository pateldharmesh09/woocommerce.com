 ...
 * @since   1.0.0
 */
class ShopMagic_OrderOnHold_Event extends ShopMagic_OrderCommon_Event {


    static protected $name = "Order On-Hold";
    static protected $slug = "shopmagic_order_on_hold_event";
    static protected $description = 'Triggered when order status is set to On-Hold';
     ...
     */
     protected function setup_hook() {
         ...
         add_action('woocommerce_order_status_on-hold', array($this, 'process_event'));
     }
